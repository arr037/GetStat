    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ResultTestId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResultTests", x => x.ResultTestId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResultQueston", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResultQueston_ResultTests_ResultTestId",
                        column: x => x.ResultTestId,
                        principalTable: "ResultTests",
                        principalColumn: "ResultTestId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxQuestion = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResultAnswer_ResultQueston_ResultQuestonId",
                        column: x => x.ResultQuestonId,
                        principalTable: "ResultQueston",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResultAnswer_ResultQuestonId",
                table: "ResultAnswer",
                column: "ResultQuestonId");

            migrationBuilder.CreateIndex(
                name: "IX_ResultQueston_ResultTestId",
                table: "ResultQueston",
                column: "ResultTestId");

            migrationBuilder.CreateIndex(
                name: "IX_Settings_TestId",
                table: "Settings",
                column: "TestId",
                unique: true);
