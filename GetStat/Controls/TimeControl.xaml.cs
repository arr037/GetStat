...
namespace GetStat.Controls
{
    public partial class TimeControl : UserControl, INotifyPropertyChanged
    {
        ...
        {
            var control = this;
            control.Value = new TimeSpan(0, 
                Convert.ToInt32(hour.SelectedItem), 
                Convert.ToInt32(min.SelectedItem), 
                0, 
                0);
            control.HourText = control.Value.Hours.ToString("D2");
            control.MinutText = control.Value.Minutes.ToString("D2");
        }
